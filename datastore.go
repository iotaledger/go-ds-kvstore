...
func (d *Datastore) handleUnknownQueryOrder(q query.Query, baseOrder query.Order) (query.Results, error) {
...
func (d *Datastore) Query(_ context.Context, q query.Query) (query.Results, error) {
	...
	case 1:
		...
		default:
			return d.handleUnknownQueryOrder(q, nil)
		}
	...
	default:
		...
		return d.handleUnknownQueryOrder(q, baseOrder)
	}
